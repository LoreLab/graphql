...
const graphqlEndpoint = "https://academy.digifemmes.com/api/graphql-engine/v1/graphql";
...
export async function login(evt) {
  ...
  try {
    const response = await fetch("https://academy.digifemmes.com/api/auth/signin", {
      method: "POST",
      headers: {
